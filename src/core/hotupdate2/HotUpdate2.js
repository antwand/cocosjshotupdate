 ...
 * @type {{}}
 */
// var HotUpdate2 = cc.Class({
    var HotUpdate2 = cc.Class.extend({
    // extends: cc.Component,

    // properties: {
        // panel: UpdatePanel,
        manifestUrl:res.manifestUrl,// "res/project.manifest",//cc.RawAsset, //project.manifest  记录当前项目各个文件的的信息
        //updateUI: cc.Node,
    ...
    //这个是检查更新   相当于查看当前有多少文件要更新   需要外部调用
    ...
    updateCb: function (event) {
        ...
        if (needRestart) {
            ...
            var newPaths = this.manifestUrl//this._am.getLocalManifest().getSearchPaths();
            cc.log(newPaths);
    ...
    //这个也是外部滴  只是自定义去更新文件而已
    loadCustomManifest: function () {
        // if (this._am.getState() === jsb.AssetsManager.State.UNINITED) {
        //
        //     var customManifestStr ;//这里获取远程的 project.manifest 更新对象
        //
